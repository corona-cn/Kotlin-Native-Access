...
interface User32 {
     ...
     */
    fun WindowFromPoint(@In @ByValue point: Long): MemorySegment
     ...
     */
    fun GetWindowPlacement(
        @In @ByRef hwnd: MemorySegment,
        @Out @ByRef lpwndpl: MemorySegment
    ): Int
     ...
     * @return Non-zero if successful, zero on failure
     */
    fun SetWindowPlacement(
        @In @ByRef hwnd: MemorySegment,
        @In @ByRef lpwndpl: MemorySegment
    ): Int
    ...
    fun SetWindowPos(
        @In @ByRef hWnd: MemorySegment,
        @In @ByRef hWndInsertAfter: MemorySegment,
        @In @ByValue x: Int,
        @In @ByValue y: Int,
        @In @ByValue cx: Int,
        @In @ByValue cy: Int,
        @In @ByValue uFlags: Int
    ): Int
     ...
     * @return Non-zero if successful, zero on failure
     */
    fun BringWindowToTop(@In @ByRef hWnd: MemorySegment): Int
     ...
     * @return Non-zero if successful, zero on failure
     */
    fun DestroyWindow(@In @ByRef hWnd: MemorySegment): Int
     ...
     */
    fun EnumWindows(
        @In @ByRef lpEnumFunc: MemorySegment,
        @In @ByValue lParam: MemorySegment
    ): Int
    ...
    fun GetWindowThreadProcessId(
        @In @ByRef hWnd: MemorySegment,
        @Out @ByRef lpdwProcessId: MemorySegment
    ): Int
    ...
    fun GetWindowTextW(
        @In @ByRef hWnd: MemorySegment,
        @Out @ByRef lpString: MemorySegment,
        @In @ByValue nMaxCount: Int
    ): Int
     ...
     */
    fun GetWindowTextLengthW(@In @ByRef hWnd: MemorySegment): Int
    ...
    fun SetWindowTextW(
        @In @ByRef hWnd: MemorySegment,
        @In @ByRef lpString: MemorySegment
    ): Int
    ...
    fun GetClassNameW(
        @In @ByRef hWnd: MemorySegment,
        @Out @ByRef lpClassName: MemorySegment,
        @In @ByValue nMaxCount: Int
    ): Int
    ...
    fun SendMessageW(
        @In @ByRef hWnd: MemorySegment,
        @In @ByValue msg: Int,
        @In @ByValue wParam: Long,
        @In @ByValue lParam: Long
    ): Long
     ...
     */
    fun DispatchMessageW(@In @ByRef lpMsg: MemorySegment): Long
     ...
     */
    fun TranslateMessage(@In @ByRef lpMsg: MemorySegment): Int
     ...
     */
    fun GetMessageW(
        @Out @ByRef lpMsg: MemorySegment,
        @In @ByRef hWnd: MemorySegment,
        @In @ByValue wMsgFilterMin: Int,
        @In @ByValue wMsgFilterMax: Int
    ): Int
     ...
     */
    fun SendInput(
        @In @ByValue cInputs: Int,
        @In @ByRef pInputs: MemorySegment,
        @In @ByValue cbSize: Int
    ): Int
     ...
     */
    fun GetKeyState(@In @ByValue nVirtKey: Int): Short
     ...
     */
    fun GetAsyncKeyState(@In @ByValue vKey: Int): Short
     ...
     * @return Non-zero if successful, zero on failure
     */
    fun GetCursorPos(@Out @ByRef lpPoint: Point): Int
     ...
     * @return Non-zero if successful, zero on failure
     */
    fun SetCursorPos(@In @ByValue x: Int, @In @ByValue y: Int): Int
    ...
    fun EnumDisplayDevicesW(
        @In @ByRef lpDevice: MemorySegment,
        @In @ByValue dwDevNum: Int,
        @Out @ByRef lpDisplayDevice: MemorySegment,
        @In @ByValue dwFlags: Int
    ): Int
    ...
    fun EnumDisplaySettingsW(
        @In @ByRef lpszDeviceName: MemorySegment,
        @In @ByValue iModeNum: Int,
        @Out @ByRef lpDevMode: MemorySegment
    ): Int
     ...
     * @return Non-zero if successful, zero on failure
     */
    fun OpenClipboard(@In @ByRef hWndNewOwner: MemorySegment): Int
     ...
     */
    fun GetClipboardData(@In @ByValue uFormat: Int): MemorySegment
    ...
    fun SetClipboardData(
        @In @ByValue uFormat: Int,
        @In @ByRef hMem: MemorySegment
    ): MemorySegment
    ...
    fun CreateCaret(
        @In @ByRef hWnd: MemorySegment,
        @In @ByRef hBitmap: MemorySegment,
        @In @ByValue nWidth: Int,
        @In @ByValue nHeight: Int
    ): Int
     ...
     * @return Non-zero if successful, zero on failure
     */
    fun HideCaret(@In @ByRef hWnd: MemorySegment): Int
     ...
     * @return Non-zero if successful, zero on failure
     */
    fun ShowCaret(@In @ByRef hWnd: MemorySegment): Int
     ...
     * @return Non-zero if successful, zero on failure
     */
    fun SetCaretPos(@In @ByValue x: Int, @In @ByValue y: Int): Int
    ...
    fun SetTimer(
        @In @ByRef hWnd: MemorySegment,
        @In @ByValue nIDEvent: Int,
        @In @ByValue uElapse: Int,
        @In @ByRef lpTimerFunc: MemorySegment
    ): Long
     ...
     */
    fun GetMenu(@In @ByRef hWnd: MemorySegment): MemorySegment
     ...
     * @return Non-zero if successful, zero on failure
     */
    fun DrawMenuBar(@In @ByRef hWnd: MemorySegment): Int
    ...
    fun SetWindowsHookExW(
        @In @ByValue idHook: Int,
        @In @ByRef lpfn: MemorySegment,
        @In @ByRef hmod: MemorySegment,
        @In @ByValue dwThreadId: Int
    ): MemorySegment
     ...
     * @return Non-zero if successful, zero on failure
     */
    fun UnhookWindowsHookEx(@In @ByRef hhk: MemorySegment): Int
     ...
     */
    fun CallNextHookEx(
        @In @ByRef hhk: MemorySegment,
        @In @ByValue nCode: Int,
        @In @ByValue wParam: Long,
        @In @ByValue lParam: Long
    ): Long
}
