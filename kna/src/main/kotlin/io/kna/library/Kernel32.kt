...
interface Kernel32 {
     ...
     */
    fun GetStdHandle(@In @ByValue nStdHandle: Int): MemorySegment
     ...
     */
    fun OpenProcess(
        @In @ByValue dwDesiredAccess: Int,
        @In @ByValue bInheritHandle: Int,
        @In @ByValue dwProcessId: Long
    ): MemorySegment
     ...
     */
    fun CloseHandle(@In @ByRef hObject: MemorySegment): Int
    ...
    fun ReadProcessMemory(
        @In @ByRef hProcess: MemorySegment,
        @In @ByRef lpBaseAddress: MemorySegment,
        @Out @ByRef lpBuffer: MemorySegment,
        @In @ByValue nSize: Long,
        @Out @ByRef lpNumberOfBytesRead: MemorySegment
    ): Int
    ...
    fun WriteProcessMemory(
        @In @ByRef hProcess: MemorySegment,
        @In @ByRef lpBaseAddress: MemorySegment,
        @In @ByRef lpBuffer: MemorySegment,
        @In @ByValue nSize: Long,
        @Out @ByRef lpNumberOfBytesWritten: MemorySegment
    ): Int
    ...
    fun CreateToolhelp32Snapshot(
        @In @ByValue dwFlags: Long,
        @In @ByValue th32ProcessID: Long
    ): MemorySegment
     ...
     */
    fun Process32FirstW(
        @In @ByRef hSnapshot: MemorySegment,
        @InOut @ByRef lppe: MemorySegment
    ): Int
     ...
     */
    fun GetSystemInfo(@Out @ByRef lpSystemInfo: MemorySegment)
     ...
     * @return Non-zero if successful, zero on failure
     */
    fun GlobalMemoryStatusEx(@Out @ByRef lpBuffer: MemorySegment): Int
     ...
     */
    fun VirtualAlloc(
        @In @ByRef lpAddress: MemorySegment,
        @In @ByValue dwSize: Long,
        @In @ByValue flAllocationType: Int,
        @In @ByValue flProtect: Int
    ): MemorySegment
    ...
    fun VirtualProtect(
        @In @ByRef lpAddress: MemorySegment,
        @In @ByValue dwSize: Long,
        @In @ByValue flNewProtect: Int,
        @Out @ByRef lpflOldProtect: MemorySegment
    ): Int
     ...
     */
    fun CreateFileW(
        @In @ByRef lpFileName: MemorySegment,
        @In @ByValue dwDesiredAccess: Int,
        @In @ByValue dwShareMode: Int,
        @In @ByRef lpSecurityAttributes: MemorySegment,
        @In @ByValue dwCreationDisposition: Int,
        @In @ByValue dwFlagsAndAttributes: Int,
        @In @ByRef hTemplateFile: MemorySegment
    ): MemorySegment
     ...
     */
    fun ReadFile(
        @In @ByRef hFile: MemorySegment,
        @Out @ByRef lpBuffer: MemorySegment,
        @In @ByValue nNumberOfBytesToRead: Int,
        @Out @ByRef lpNumberOfBytesRead: MemorySegment,
        @In @ByRef lpOverlapped: MemorySegment
    ): Int
    ...
    fun WriteFile(
        @In @ByRef hFile: MemorySegment,
        @In @ByRef lpBuffer: MemorySegment,
        @In @ByValue nNumberOfBytesToWrite: Int,
        @Out @ByRef lpNumberOfBytesWritten: MemorySegment,
        @In @ByRef lpOverlapped: MemorySegment
    ): Int
     ...
     */
    fun GetModuleHandleW(@In @ByRef lpModuleName: MemorySegment): MemorySegment
     ...
     */
    fun GetProcAddress(
        @In @ByRef hModule: MemorySegment,
        @In @ByRef lpProcName: MemorySegment
    ): MemorySegment
    ...
    fun FormatMessageW(
        ...
        @In @ByRef lpSource: MemorySegment,
        @In @ByValue dwMessageId: Int,
        @In @ByValue dwLanguageId: Int,
        @Out @ByRef lpBuffer: MemorySegment,
        @In @ByValue nSize: Int,
        @In @ByRef arguments: MemorySegment
    ): Int
}